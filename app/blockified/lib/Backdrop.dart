...
class Backdrop extends StatefulWidget {
  final NavigatorItem currentNavigator;
...
class _BackdropState extends State<Backdrop>
  ...
  void didUpdateWidget(Backdrop old) {
    ...
    if (widget.currentNavigator != old.currentNavigator) {
      setState(() {
        _controller.fling(
            velocity:
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    ...
    return Container(
      key: _backdropKey,
      color: widget.currentNavigator.color,
      child: Stack(
        children: <Widget>[
          widget.backPanel,
          PositionedTransition(
            ...
            child: _BackdropPanel(
              ...
              title: Text(widget.currentNavigator.name),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: widget.currentNavigator.color,
        elevation: 0.0,
        leading: IconButton(
